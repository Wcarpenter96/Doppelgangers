                ...
                <container>
                    ...
                    <div className="Container">
                        <div className="row">
                            ...
                            <div className="col-md-1">{JSON.stringify(this.props.matches[0])}</div>
                            ...
                            <div className="col-md-5">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="card">
                                            <img src={this.props.matches[0].celeb ? this.props.matches[0].celeb.url : ''} className="card-img-top" />
                                            <div className="card-body text-center">
                                                <h5 className="card-title">{this.props.matches[0].celeb  ? this.props.matches[0].celeb.name : 'Loading...'}</h5>
                                                <p className="card-text">Confidence:{this.props.matches[0].celeb  ? this.props.matches[0].confidence : ''}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
